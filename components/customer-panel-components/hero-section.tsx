            ...
            >
              ...
              <motion.div variants={leftVariant} className="flex items-center max-sm:justify-center gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  className="whitespace-nowrap border-primary/50 text-foreground hover:border-none cursor-pointer"
                >
                ...
                <Button
                  size="sm"
                  className="whitespace-nowrap bg-primary text-white cursor-pointer"
