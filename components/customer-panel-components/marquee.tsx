...
export default function Marquee() {
  ...
  const content = (
    <>
      <span className="mx-6 text-9xl max-md:text-4xl font-bold text-primary"> Welcome to Our Store — Great Deals Everyday! </span>
      <span className="mx-6 text-9xl max-md:text-4xl font-bold text-primary">Shop Now — Free Shipping on Orders Over $50 — Limited Time!</span>
      <span className="mx-6 text-9xl max-md:text-4xl font-bold text-primary">New Arrivals — Check Them Out!</span>
    </>
  );
